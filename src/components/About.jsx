...
import Image1 from "../assets/Images/12.jpeg";
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-12">
          ...
          <div className="md:w-1/2 w-full text-left">
            ...
            <p className="text-gray-300 mb-6 text-sm sm:text-base leading-relaxed">
              I'm Thilan Kavishka, a passionate Full Stack Web Developer. I
              specialize in building modern web applications with responsive
              design and clean code.
            </p>
            <p className="text-gray-300 mb-6 text-sm sm:text-base leading-relaxed">
              I'm currently an undergraduate at the University of Jaffna in Sri
              Lanka, pursuing my degree while continuously expanding my skills
              in full stack web development. I’m passionate about learning new
