...
import ProfileImage from "../assets/Images/11.jpeg"; // Update path if needed

const Hero = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center pt-16 bg-black text-white"
    >
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
          ...
          <div className="text-center md:text-left flex-1">
            ...
            <div className="flex justify-center md:justify-start space-x-6">
              <a
                href="https://github.com/Thilankavishka"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/thilan-kavishka-749857251"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-white transition"
              >
              ...
              <a
                href="https://www.facebook.com/share/1HtNTypZEQ/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-white transition"
              >
